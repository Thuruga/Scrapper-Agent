...
logger = logging.getLogger("ScraperTommy")

async def scrape_competitor_product(
    product_url: str, brand_name: str
) -> Optional[RawProductBronze]:
    """Extrai os dados de um produto da Tommy Hilfiger delegando para o VtexApiClient."""
    try:
...
if __name__ == "__main__":
    # Configuração básica para teste manual
