    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            if intercepted_api_data:
                ...
                composition = merged_specs.get("Composição") or merged_specs.get(
                    "Material"
                )
                ...
                product_data = RawProductBronze(
                    ...
                    price_full=dom_data[
                        "price"
                    ],  # DOM Price Costuma ser mais preciso nas ofertas
                ...
                composition = dom_data["specs"].get("Composição") or dom_data[
                    "specs"
                ].get("Material")
