...
async def scrape_competitor_product(
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # --- ATUALIZADO: Agente Ativo Generalista ---
            ...
            for texto in botoes_alvo:
                try:
                    # Busca ignorando maiúsculas/minúsculas usando XPath
                    ...
                    for el in elementos:
                        if await el.is_visible():
                            ...
                            break  # Achou e clicou, sai do loop de elementos
                except:
                    continue  # Se der erro neste seletor, tenta a próxima palavra da lista
            ...
            if (
                ...
                dom_result = await page.evaluate("""() => {
                    ...
                    // 2. Busca Força Bruta via Regex no JSON inteiro (Reserva às vezes chama de 'Composicao' sem til)
                    if (!specs['Composição']) {
                    ...
                    document.querySelectorAll('span, p, div, li').forEach(el => {
                        ...
                        // Na Reserva, as letras de tamanho às vezes ficam em caixas específicas
                        if (['P', 'M', 'G', 'GG', 'XGG', 'XXG', '3G', '4G', '38', '40', '42'].includes(txt)) {
