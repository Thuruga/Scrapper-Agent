...
def buscar_familia_de_cores(
    referencia_completa: str, product_id: str, dominio: str
) -> list[str]:
    """
...
def extrair_produtos_da_api(
    dominio: str, marca: str, pagina: int = 1
    ...
    try:
        ...
        for p in dados.get("products", []):
            ...
            cores_irmas = buscar_familia_de_cores(
                referencia_produto, id_produto, dominio
            )
...
if __name__ == "__main__":
    ...
    produtos = extrair_produtos_da_api(
        dominio="www.aramis.com.br/roupas/camisas", marca="Aramis", pagina=1
    )
